...
// CRUD  Reservaciones
 ...
 app.get('/api/Reservaciones', async(req, res) =>{
    //busca todas las reservaciones en la base 
 ...
 app.post('/api/Reservaciones', async(req, res)=>{
    ...
    await nuevo.save();
//responde con un mensaje de exito
res.status(201).send ('Reservacion creada creado');
 });

 //eliminar una rservacion por id
 app.delete('/api/Reservaciones/:id', async(req,res)=>{
    ...
    //responde con un mensaje de exito
    res.send('Reservacion eliminado eliminado');
 });
